...
def cli():
    ...
    parser.add_argument('--n_meta_agent_learning_cycles', type=int, default=31)
    parser.add_argument('--n_agents_learning_cycles', type=int, default=20)
    ...
    parser.add_argument('--thresholds', nargs="*", type=float, default=[0])
