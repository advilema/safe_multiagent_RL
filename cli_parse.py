...
def cli():
    ...
    parser.add_argument('--n_meta_agent_learning_cycles', type=int, default=2)
    parser.add_argument('--n_agents_learning_cycles', type=int, default=50)
    ...
    parser.add_argument('--thresholds', nargs="*", type=float, default=[25, 25, 25, 25, 25])
